...
export default function ProfileScreen({ navigation }) {
  ...
  const goToReturn = () => {
    ...
    navigation
      .getParent()              // <-- this is your root StackNavigator
      ?.navigate('ReturnUser', {    // <-- the screen name in the root Stack
        userId: user._id        // <-- pass the real MongoID field
      });
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('BookManagement')}>
